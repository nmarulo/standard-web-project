...
El propósito de Standard Web Project es tener un proyecto que sirva como base para iniciar nuevos proyectos, además, lo usare para probar y seguir aprendiendo sobre nuevos conceptos, librerías, etc... de Java.
...
- Gestión de usuarios
- Gestión de perfiles (En curso)
- Gestión de permisos (En curso)
- Gestión de configuración (En curso)
...
- Maven >= v3.6.3
- WildFly >= v15
- MariaDB >= v10 o MySQL >= 5.7.29
- Mysql Connector java (Connector/J) >= v5.1.47

### Imágenes

#### Login

![login](resources/images/login.jpg "login")

#### Gestión de usuarios

![users](resources/images/users.jpg "users")

Thanks
--------------------

Thanks to [JetBrains](https://www.jetbrains.com/?from=SoftN%20CMS) for providing a license for IntelliJ IDEA to develop this project.

| JetBrains  | IntelliJ IDEA |
| ------------- | ------------- |
| ![jetbrains](resources/images/jetbrains.svg "jetbrains") | ![IntelliJ-IDEA](resources/images/intellij-idea.svg "intellij-idea") |

Licencia (MIT https://opensource.org/licenses/MIT)
--------------------

Copyright (c) 2020 Nicolás Marulanda P.
