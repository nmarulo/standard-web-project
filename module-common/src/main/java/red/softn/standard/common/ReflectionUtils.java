...
public class ReflectionUtils {
    ...
    public static String getClassNameWithoutPackage(Class<?> clazz) {
        ...
        clazz.getSimpleName(); // Con este método ya no tiene uso "getClassNameWithoutPackage".
    ...
    public static boolean isHashCodeMethod(Method method) {
        return (method != null && method.getName()
                                        .equals("hashCode") && method.getParameterCount() == 0);
    }
    ...
    public static boolean isSetter(Method method) {
        return method.getReturnType()
                     .equals(Void.TYPE) && !Modifier.isStatic(method.getModifiers()) && method.getParameterTypes().length == 1;
    }
